...
<a href="/专业技能/容器化/docker" class="mini-card">
  <span class="icon">🐳</span>
  <span class="name">Docker</span>
</a>

<a href="/专业技能/容器化/kubernetes" class="mini-card">
  <span class="icon">☸️</span>
...
<a href="/专业技能/数据库/mysql" class="mini-card">
  <span class="icon">🐬</span>
  <span class="name">MySQL</span>
</a>

<a href="/专业技能/数据库/postgresql" class="mini-card">
  <span class="icon">🐘</span>
  <span class="name">PostgreSQL</span>
</a>

<a href="/专业技能/数据库/redis" class="mini-card">
  <span class="icon">🔴</span>
  <span class="name">Redis</span>
</a>

<a href="/专业技能/数据库/mongodb" class="mini-card">
  <span class="icon">🍃</span>
